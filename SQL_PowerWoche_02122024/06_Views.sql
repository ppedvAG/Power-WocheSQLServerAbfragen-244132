USE Northwind
GO
-- Views: Eine Ansicht, die definiert wird durch ihren Inhalt der Abfrage:

/*
	Vorteile:
	- Komplexere Abfragen reinspeichern
	- Sicherheit: User erlauben nur die View zu lesen, aber nicht zu verändern
	- Views immer aktuell sind:
		=> beim Aufruf der View wird das hinterlegte Statment ausgeführt
*/
